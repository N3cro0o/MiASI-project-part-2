...
public class ReviewTest {
    ...
    void testReviewCreation_fieldsSetCorrectly() {
        Review review = new Review(1, 101, 5, (short)4, "Recenzja", LocalDateTime.parse("2026-06-01T12:00:00"));
        ...
        assertEquals(LocalDateTime.parse("2026-06-01T12:00:00"), review.created());
    }
}
